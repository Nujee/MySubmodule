...
namespace Code.BlackCubeSubmodule.Editor.EditorExtensions
{
    ...
    public sealed class FloatRangeCustomPropertyDrawer : PropertyDrawer 
    {
        private const float SubLabelSpacing = 4;
        private const float BottomSpacing = 2;

        public override void OnGUI(Rect pos, UnityEditor.SerializedProperty property, GUIContent label)
        {
